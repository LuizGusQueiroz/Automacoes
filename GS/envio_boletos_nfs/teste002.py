...
class GerenciadorDocumentos:
    ...
    def encontrar_documento_boleto(self, linhas_texto: List[str]) -> Optional[str]:
        """Encontra CNPJ ou CPF no boleto, priorizando CNPJ"""
        cnpjs = []
        cpfs = []
    ...
    def encontrar_documentos_nf(self, texto: str) -> List[str]:
        """Encontra todos os CNPJs e CPFs na NF, filtrando o CNPJ ignorado"""
        documentos = []
    ...
    def enviar_emails(self) -> bool:
        ...
        for documento in tqdm(subpastas, desc="Enviando emails", unit="documento"):
            # Verifica se é um CNPJ mapeado (CPFs não são enviados por padrão)
...
Sistema Automático"""
    ...
    def executar(self) -> None:
        ...
        self.organizar_nfs()
        print("\n[ETAPA 3/3] Mesclando pastas com documento correspondente...")
        self.mesclar_pastas()
